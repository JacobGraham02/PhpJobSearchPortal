...
abstract class AbstractValidate {
    ...
    public $regex_patterns_for_input_fields = array (
        ...
        'username' => "/^[a-z{3,}A-Z{3,}0-9{1,}{!()-.?`~;:!@#$%^&*+= }{1,}]{6,}$/",
        'password' => "/^[a-z{3,}A-Z{3,}0-9{1,}{!()-.?`~;:!@#$%^&*+= }{1,}]{10,}$/",
        'confirm_password' => "/^[a-z{3,}A-Z{3,}0-9{1,}{!()-.?`~;:!@#$%^&*+= }{1,}]{10,}$/"
    );

    public $form_request_errors = array (
        'invalid_form_request_type' => 'An invalid request type has been used. If you are a user, contact the site administrator located at the bottom of the page for help.',
        'invalid_form_request_data' => 'The data passed in your request cannot successfully be validated. Therefore, your request has been discarded'
    );

    abstract protected function validateString($input_field_name, $input_field_value): bool;
}